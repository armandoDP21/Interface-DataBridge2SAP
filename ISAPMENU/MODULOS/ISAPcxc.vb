...
Public Class ISAPcxc
    ...
    Public Function ProcesarCxC() As Integer
        ...
        'InfoCache.Secuencia = My.Settings.Secuencia
...
#Region "Inicializacion"
    Private Sub CargarMaestro()
        ...
        'TODO: podria utilizar para el log
        'With VerDatosForm
    ...
    Private Sub CargarImpuestosProducto()
        RaiseEvent Mensaje(Format(Date.Now, "R") & ">  " & "Cargando ImpuestosCarga.")
        My.Application.DoEvents()
    ...
    Private Sub CargarCatalogoPolizas()
        RaiseEvent Mensaje(Format(Date.Now, "R") & ">  " & "Cargando Catalogo de Pólizas.")
        '
        'My.Application.DoEvents()
...
#Region "Liquidaciones y Movimientos de Productos"
    Private Sub CargarLiquidaciones()
        RaiseEvent Mensaje(Format(Date.Now, "R") & ">  " & "Cargando liquidaciones.")
    ...
    End Sub
    Private Sub CargarMovimientosProducto()
        RaiseEvent Mensaje(Format(Date.Now, "R") & ">  " & "Cargando  movimientos de productos.")
...
#Region "Procesar datos"
    ...
    Private Sub T2DevolucionesCostaRica(ByVal MasterTableRow As VS_CATALOGOPOLIZASData.VS_CATALOGOPOLIZASRow)
        ...
        If InfoCache.PaisClave = 6 Then
            With MovimientosDeProductos.VS_DEVOLUCIONESCR
                For Each tablerow As MovimientosDeProductosData.VS_DEVOLUCIONESCRRow In .Rows
                    If tablerow.IsDESCUENTONull Then
                        tablerow.DESCUENTO = 0
                    End If
                Next
            End With

            With MovimientosDeProductos.VS_DEVOLUCIONESSINIVACR
                For Each tablerow As MovimientosDeProductosData.VS_DEVOLUCIONESSINIVACRRow In .Rows
                    If tablerow.IsDESCUENTONull Then
                        tablerow.DESCUENTO = 0
                    End If
                Next
            ...
            For Each tablerow As ProcesadasData.PolizasCRow In .Rows
                With SapGLInterfase.SAP_GL_INTERFASE
                    ...
                    With NewDataRow
                        ...
                        Dim ValorDR As Decimal = CDec(Format(tablerow.MONTODR, "0.00"))
                        Dim ValorCR As Decimal = CDec(Format(tablerow.MONTOCR, "0.00"))
                        .ENTERED_DR = ValorDR 'tablerow.MONTODR
                        .ENTERED_CR = ValorCR 'tablerow.MONTOCR
...
#Region "Balancear"
    ...
    Private Sub AddDiff2Dr(Ajuste As Decimal, Referencia As String)
        With SapGLInterfase.SAP_GL_INTERFASE
            For Each tablerow As SAP_GLINTERFASEData.SAP_GL_INTERFASERow In .Rows
                If tablerow.REF_DOCUMENT_NUMBER = Referencia Then
                    If tablerow.ENTERED_DR > 0 Then
                        tablerow.ENTERED_DR += Ajuste
    ...
    Private Sub AddDiff2Cr(Ajuste As Decimal, Referencia As String)
        With SapGLInterfase.SAP_GL_INTERFASE
            For Each tablerow As SAP_GLINTERFASEData.SAP_GL_INTERFASERow In .Rows
                If tablerow.REF_DOCUMENT_NUMBER = Referencia Then
                    If tablerow.ENTERED_CR > 0 Then
                        tablerow.ENTERED_CR += Ajuste
                        tablerow.AcceptChanges()
                        Exit For
                    End If
                End If
