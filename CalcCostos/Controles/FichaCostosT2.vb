...
#Region "Metodos"
    Public WriteOnly Property EmbarqueClave As String
        Set(ByVal value As String)
            ...
            GastosTipo.RowFilter = "EMBARQUE_CLAVE='" & value & "'" & " and Tipo=2"
            Me.GridGastos.DataSource = Me.GastosTipo
            AddHandler InfoCache.EmbarquesDS.EMBARQUESGASTOS.TotalT2, AddressOf PresentarTotales
        End Set
    End Property
